...
class cspace:
    def __init__(self):
        self.theta_lim = {
        '0':{
        'min':(-175.0/180.0*np.pi),
        'max':(175.0/180.0*np.pi),
        'vmax':(30.0/180.0*np.pi),
        },
        '1':{
        'min':(-74.61/180.0*np.pi),
        'max':(-125.39/180.0*np.pi),
        'vmax':(30.0/180.0*np.pi)
        },
        '2':{
        'min':(-164.61/180.0*np.pi),
        'max':(35.39/180.0*np.pi),
        'vmax':(30.0/180.0*np.pi),
        },
        '3':{
        'min':(-165.0/180.0*np.pi),
        'max':(-165.0/180.0*np.pi),
